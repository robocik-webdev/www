<!-- <script>
  ...
  const socialMedia = [
    ['linkedin.png', 'https://zw.linkedin.com/company/ko%C5%82o-naukowe-automatyki-i-robotyki-robocik'],
...
<section id="contact">
  ...
  <div class="column column-1">
    <div class="item">
      ...
      <div class="content">
        <img class="icon" src="/icon/contact/location.png" alt="location icon" />
        <div class="text">
...
<div class="footnote">
  <span>Designed with ❤️ and ☕ by:</span>
  <span class="names">Mikołaj Kaźmierczak&nbsp; & &nbsp;Darya Machulskaya</span>
  <span class="names">Kuba Borowiec&nbsp; & &nbsp;Katarzyna Smagacz</span>
