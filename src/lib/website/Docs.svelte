<script>
  ...
  import { opened } from '$lib/website/docs/sidebar';
  import Sidebar from '$lib/website/docs/bluenemo/Sidebar.svelte';
  import Content from '$lib/website/docs/bluenemo/Content.svelte';
